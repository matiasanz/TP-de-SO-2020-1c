...
#ifndef SRC_HILO_APPEARED_POKEMON_H_
#define SRC_HILO_APPEARED_POKEMON_H_
...
void subscribir_y_escuchar_cola_appeared_pokemon();

#endif /* SRC_HILO_APPEARED_POKEMON_H_ */
