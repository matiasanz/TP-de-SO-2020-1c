 ...
 * IMPORTANTE: Esta funcion debe usarse unicamente desde Broker
 ...
 * Los procesos que usen esta funcion deben definir la función de escucha.
 */
 ...
 * Luego realiza escucha activa de mensajes (escucha activa).
 *  Al recibir un mensaje lo reenvia a través de la funcion de escucha que
 * recibe por parámeetro llamada mensaje_recibido(...)
 * Los procesos que usen esta funcion deben definir la función de escucha.
 */
