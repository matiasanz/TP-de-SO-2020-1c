...
///* ********* a Futuro ********* */
//
//typedef struct RecursosCacheados{
//	t_id idEntrenador;
//	matriz_recursos pedidosDelEntrenador; //Ver si vale la pena duplicar, teniendo en cuenta que solo voy a trabajar con entrenadores bloqueados
//	matriz_recursos recursosAsignados;
//	matriz_recursos recursosSobrantes;
//}recursos_cacheados;
//
////recursos_cacheados cacheados_create(entrenador*unEntrenador){
////	return (recursos_cacheados) {unEntrenador->id, unEntrenador->objetivos, unEntrenador->pokemonesCazados, entrenador_recursos_sobrantes(unEntrenador)};
////}
//
///* --------------------------- */
//
...
//	entrenador*otroOtroMas    = entrenador_ptr_crear(1, "c", "d", posicion_create(1,1));
//	entrenador*unEntrenador   = entrenador_ptr_crear(2, "b", "c", posicion_create(1,1));
